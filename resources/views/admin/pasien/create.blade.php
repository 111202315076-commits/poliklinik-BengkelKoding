...
<div class="flex items-center gap-3 mb-6">
    <a href="{{ route('admin.pasien.index') }}" class="flex items-center justify-center w-9 h-9 
        ...
        <form action="{{ route('admin.pasien.store') }}" method="POST">
            ...
            <div class="mb-8">
                ...
                <input type="password" name="password_confirmation"
                    ...
                    class="w-full border-2 rounded-lg p-2" required>
            </div>

            {{-- Buttons --}}
            <div class="flex gap-3">
                <button type="submit"
                    class="px-6 py-2.5 rounded-xl bg-primary 
                ...
                <a href="{{ route('admin.pasien.index') }}"
                    class="px-6 py-2.5 rounded-xl bg-slate-100 
