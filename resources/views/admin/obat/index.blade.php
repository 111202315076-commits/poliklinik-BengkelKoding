<x-layouts.app title="Data Obat">
    ...
    <div class="flex items-center justify-between mb-6">
        ...
        <div class="flex gap-2">
            <a href="{{ route('admin.obat.export') }}" class="inline-flex items-center gap-2 px-5 py-2.5 
            ...
            <a href="{{ route('admin.obat.create') }}" class="inline-flex items-center gap-2 px-5 py-2.5 
                        ...
                        <tr class="border-t border-slate-100 hover:bg-slate-50 transition">
                            ...
                            <td class="px-6 py-4 text-right">
                                <div class="flex justify-end gap-2">
                                    ...
                                    {{-- Edit --}}
                                    <a href="{{ route('admin.obat.edit', $obat->id) }}" class="inline-flex items-center gap-1 px-4 py-2 
