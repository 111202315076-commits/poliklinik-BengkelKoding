<x-layouts.app title="Tambah Obat">
    ...
    <div class="flex items-center gap-3 mb-6">
        <a href="{{ route('admin.obat.index') }}" class="flex items-center justify-center w-9 h-9 
        ...
        <div class="card-body p-8">
            ...
            <form action="{{ route('admin.obat.store') }}" method="POST">
                    ...
                    <div>
                        ...
                        <input type="text" name="kemasan" value="{{ old('kemasan') }}"
                            placeholder="Contoh: Strip, Botol, Tube..." class="w-full px-4 py-2 border-2 rounded-lg p-2
                                      focus:border-primary focus:outline-none
                                      @error('kemasan') border-red-500 @enderror" required>
                        @error('kemasan')
                        <p class="text-xs text-red-500 mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                    ...
                    <div>
                        ...
                        <div class="flex items-center border-2 rounded-lg p-2 px-4 py-2
                            ...
                            <input type="number" name="harga_obat" value="{{ old('harga_obat') }}" placeholder="0" min="0" step="1"
                                class="w-full focus:outline-none
                                          @error('harga_obat') border-red-500 @enderror" required>
                        </div>
                    ...
                    <div>
                        ...
                        <input type="number" name="stok" value="{{ old('stok') }}"
                            placeholder="0" min="0" class="w-full px-4 py-2 border-2 rounded-lg p-2
                                      focus:border-primary focus:outline-none
                ...
                <div class="flex gap-3">
                    ...
                    <a href="{{ route('admin.obat.index') }}" class="px-6 py-2.5 rounded-xl bg-slate-100 
